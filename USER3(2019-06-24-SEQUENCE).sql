...
CREATE TABLE tbl_score(
    ...
    -- AUTO INCREMENT : 다른 DBMS에서는 INSERT를 수행할때
...
-- 그래서 데이터를 강제로 물리적 Table에 저장해줄 칠요가 있다.
COMMIT;
-- ROLLBACK과 반대되는 개념

INSERT INTO tbl_score(sc_seq,sc_num,sc_subject,sc_score)
VALUES(SEQ_SCORE.NEXTVAL,'00003','국어',77);

INSERT INTO tbl_score(sc_seq,sc_num,sc_subject,sc_score)
VALUES(SEQ_SCORE.NEXTVAL,'00003','영어',89);
...
-- 취소와 비슷한 개념이며
-- 가장최근에 COMMIT된 이후의 명령수행(CUD)을 취소하는 역할
-- 또는 가장 최근에 CREATE 명령을 수행한 이후의 명령수행(CUD)을 취소하는 역학
ROLLBACK;
SELECT
    *
FROM tbl_score;
